...
<%@ taglib prefix="s" uri="/struts-tags" %>
    		...
    		<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						...
						<s:select list="{1,3,5,10,20,50}" name="qo.pageSize" class="ui_select02"/>
						转到第<s:textfield name="qo.currentPage" cssClass="ui_input_txt01" type="number" min="1" style="width:50px;"/>
